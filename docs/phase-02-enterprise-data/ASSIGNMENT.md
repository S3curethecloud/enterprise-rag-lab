# Learner Assignment — Enterprise Data and Metadata
...
> Metadata is the shipping label on a container. The contents matter, but the label tells you who owns it, where it came from, how sensitive it is, and who may open it.
...
> **Enterprise data without security metadata is data whose access policy has been separated from the data itself.**
...
1. Why does an enterprise RAG system need stable document IDs?
2. What does tenant metadata protect?
3. What is the difference between classification and an ACL?
4. Why does provenance matter?
5. Which metadata should survive the entire RAG lifecycle?
...
A warehouse contains 10,000 correctly packed boxes, but every shipping label is removed. What capabilities and protections have been lost? Map each loss to enterprise RAG.
...
Write 700-1000 words defending: **Metadata is part of the enterprise RAG security boundary.**
...
How must Phase 3 preserve these metadata properties when documents are divided into chunks?
