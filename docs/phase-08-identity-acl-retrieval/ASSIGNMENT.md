# Learner Assignment — Identity and ACL-Aware Retrieval
...
> Retrieval is the librarian finding the book. Authorization is the librarian checking whether your library card permits you to borrow it.
...
> **A document can be perfectly relevant and completely unauthorized at the same time.**
...
1. What is identity propagation?
2. Why are tenant boundaries important?
3. How do user groups and resource ACLs interact?
4. Why must authorization occur before context assembly?
5. Why should authorization denials be explicit and testable?
...
Alice asks for an HR compensation document. Search finds exactly the correct HR document. What must happen next, and why should the LLM not participate in that decision?
...
Write 700-1000 words defending: **The most relevant result may be the result the system must refuse to use.**
...
After authorization, how should Phase 9 decide what is safe to place into the model context?
