# Learner Assignment — Grounded Generation
...
> The LLM is a lawyer who may argue only from evidence admitted into the case. No admissible evidence means no evidence-based argument.
...
1. What does grounded generation mean?
2. Why should trusted instructions be separated from retrieved data?
3. What is hallucination in a RAG system?
4. Why should empty context cause abstention?
5. What does source attribution prove, and what does it not prove?
...
A lawyer knows a rumor that could win a case but cannot produce admissible evidence. Should the rumor be presented as established fact? Map this to enterprise-grounded generation.
...
Write 700-1000 words defending: **Abstention is a sign of RAG reliability rather than system failure.**
...
Even if an answer is grounded, what additional disclosure risks must Phase 11 inspect?
