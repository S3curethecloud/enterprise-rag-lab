# Learner Assignment — Secure Chunking
...
> Cutting a classified map into 100 pieces does not make any piece public. Each piece inherits the sensitivity of the original map.
...
> **Chunking changes the unit of retrieval but must never erase the security properties of the parent document.**
...
1. Why is chunking necessary in RAG?
2. How do chunk size and overlap affect retrieval?
3. Why should chunk IDs remain traceable to parent documents?
4. Which security metadata must survive chunking?
5. What could happen if ACL metadata disappears during chunk creation?
...
A CONFIDENTIAL document is split into thirty paragraphs. One paragraph no longer carries its classification label. Has it become public? Explain the architectural failure.
...
Write 700-1000 words defending: **Security metadata inheritance is as important as semantic chunk quality.**
...
How do these chunks become mathematical representations in Phase 4 without losing their security identity?
