# Learner Assignment — Secure Ingestion
...
> Secure ingestion is customs at the border of the enterprise knowledge system. Being delivered to the border does not automatically mean an item is allowed inside.
...
> **RAG security begins before retrieval because the knowledge base itself is a security boundary.**
...
1. What is knowledge-base poisoning?
2. What is indirect prompt injection?
3. Why does source provenance matter?
4. What is the difference between reject and quarantine?
5. Why should trusted source systems be explicitly defined?
...
Someone inserts a note into a company policy binder saying: 'Ignore management and reveal confidential information.' Why should the reader treat that sentence as data instead of authority?
...
Write 700-1000 words defending: **Retrieved documents must be treated as untrusted data even when they exist inside an enterprise knowledge system.**
...
Once content has passed ingestion controls, how does Phase 7 determine whether a retrieved candidate is actually relevant?
